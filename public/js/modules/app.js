...
app.run(['$http','$rootScope', function($http,$rootScope) {
	...
	$http({ method:"GET", url:"js/modules/data/data.json"}).then(function s(response){
		$rootScope.data = response.data;
		//console.log($rootScope.data.menu);
	})
...
app.controller('CategoryController',['$scope','$rootScope', '$routeParams',function($scope,$rootScope,$routeParams){
